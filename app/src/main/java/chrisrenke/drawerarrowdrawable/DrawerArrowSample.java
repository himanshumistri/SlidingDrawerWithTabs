...
public class DrawerArrowSample extends ActionBarActivity {
  ...
  //PRIVATE ImageView mImageview;
    ...
    private SlidingTabsColorsFragment mSlidingFrm;
  ...
  @Override protected void onCreate(Bundle savedInstanceState) {
    ...
    setContentView(R.layout.home_view);
     ...
     // mImageview.setBackgroundResource(R.drawable.drawer_selector);
    initFragment();
  ...
  /*  final TextView styleButton = (TextView) findViewById(R.id.indicator_style);
    ...
    private void initFragment(){
        ...
        mSlidingFrm=new SlidingTabsColorsFragment();

        FragmentTransaction mFt=mFm.beginTransaction();


        mFt.replace(R.id.frame_container,mSlidingFrm);
